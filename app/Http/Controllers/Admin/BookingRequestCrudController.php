...
use App\Http\Requests\bookingRequestRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;
use Carbon\Carbon;

/**
 * Class bookingRequestCrudController
...
class BookingRequestCrudController extends CrudController
{
    ...
    use Operations\RejectOperation;
    use Operations\ApproveOperation;

    public function setup()
    {
        CRUD::setModel(\App\Models\Bookings::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/bookings/pending-request');
    ...
    protected function setupShowOperation()
    {
        ...
        CRUD::addButton('line', 'reject', 'view', 'crud::buttons.reject', 'beginning');
        CRUD::addButton('line', 'approve', 'view', 'crud::buttons.approve', 'beginning');
    }
}